    ...
    return (
        <>
            <Box textAlign="center" p={2} className={classes.headingColor} mb={2}>
                <Typography variant="h2">React CRUD with Json server</Typography>
            </Box>
                ...
                <Grid item md={6} xs={12}>
                    ...
                    <form>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField autoComplete="username" name="username" variant="outlined" required fullWidth id="username" label="Name" value={user.username} onChange={e => onTextFieldChange(e)} />
                            </Grid>
                            <Grid item xs={12}>
                                <TextField autoComplete="email" name="email" variant="outlined" required fullWidth id="email" label="Email Address" value={user.email} onChange={e => onTextFieldChange(e)} />
                            </Grid>
                        </Grid>
                        <Box m={3}>
